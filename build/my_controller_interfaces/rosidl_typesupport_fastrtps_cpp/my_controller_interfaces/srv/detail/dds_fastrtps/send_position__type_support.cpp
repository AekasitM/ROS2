...
#include "my_controller_interfaces/srv/detail/send_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_controller_interfaces::srv::SendPosition_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_controller_interfaces::srv::SendPosition_Request & ros_message)
{
  // Member: position
...
{
  auto typed_message =
    static_cast<const my_controller_interfaces::srv::SendPosition_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_controller_interfaces::srv::SendPosition_Request *>(
    untyped_ros_message);
...
{
  return &my_controller_interfaces::srv::typesupport_fastrtps_cpp::_SendPosition_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_controller_interfaces, srv, SendPosition_Request)() {
  return &my_controller_interfaces::srv::typesupport_fastrtps_cpp::_SendPosition_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_controller_interfaces
cdr_serialize(
  const my_controller_interfaces::srv::SendPosition_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_controller_interfaces::srv::SendPosition_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const my_controller_interfaces::srv::SendPosition_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_controller_interfaces::srv::SendPosition_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_controller_interfaces::srv::typesupport_fastrtps_cpp::_SendPosition_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_controller_interfaces, srv, SendPosition_Response)() {
  return &my_controller_interfaces::srv::typesupport_fastrtps_cpp::_SendPosition_Response__handle;
}
...
{
  return &my_controller_interfaces::srv::typesupport_fastrtps_cpp::_SendPosition__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_controller_interfaces, srv, SendPosition)() {
  return &my_controller_interfaces::srv::typesupport_fastrtps_cpp::_SendPosition__handle;
}
